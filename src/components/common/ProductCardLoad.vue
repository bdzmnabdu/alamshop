...
<template>
  <div
    class="border border-neutral-200 rounded-xl hover:shadow-lg w-full overflow-hidden"
  >
    <div class="h-40 border-b">
      <div class="w-full h-[150px] flex justify-center items-center">
        <i class="pi pi-image text-[50px] text-slate-300 animate-pulse"></i>
      </div>
    </div>
